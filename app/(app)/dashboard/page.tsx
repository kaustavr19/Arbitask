...
export default async function DashboardPage() {
  ...
  const noteCount = await db.note.count({ where: { authorId: session.user.id } });
  const stats = calcStats(projects.map((p) => ({ tasks: p.tasks })), noteCount);
    ...
    <div style={{ width: "100%", maxWidth: 900, margin: "0 auto" }}>
      ...
      <div
        ...
        style={{
          ...
          border: `2px solid ${stats.currentLevel.color}33`,
          marginBottom: 24,
        }}
      >
